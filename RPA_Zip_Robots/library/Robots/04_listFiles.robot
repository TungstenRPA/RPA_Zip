  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="3" id="4">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ExpressionURLProvider2">
            <property name="expression" class="String">host + "/webzip/ref/listFiles.html"</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="6">
        <property name="name" class="String">GET /webzip/rest/archive/archivename.zip/content</property>
        <property name="stepAction" class="CallRESTWebService2" serializationversion="1">
          <property name="urlProvider" class="Expression" serializationversion="1">
            <property name="text" class="String">host + "/webzip/rest/archive/" + input.archive + "/content"</property>
          </property>
