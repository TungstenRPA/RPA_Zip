  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="3" id="5">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ExpressionURLProvider2">
            <property name="expression" class="String">host + "/webzip/ref/deleteFile.html"</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="7">
        <property name="name" class="String">DELETE /webzip/rest/archive/backup.zip/content</property>
